...
def get_kpi_cost(
    ...
    daily_costs = kpi_service.get_daily_costs(db, realm.id, start_date, end_date, user_id)
    total_cost = kpi_service.get_total_cost(db, realm.id, start_date, end_date, user_id)
    total_usage_fees = kpi_service.get_total_usage_fees(db, realm.id, start_date, end_date, user_id)
    most_used_models = kpi_service.get_most_used_models(db, realm.id, start_date, end_date, user_id)
    model_costs = kpi_service.get_model_costs(db, realm.id, start_date, end_date, user_id)
